...
class DifferentialEvolution:
    def __init__(self, x0, num_env, de_type='de', bounds=(0,1), params=None, output_dir="./results"):
        self.population_size = params['pop_size']
...
class RandomSampling:
    def __init__(self, x0,  num_env, bounds=(0,1), params=None, output_dir="./results"):
        self.population_size = params['pop_size']
        self.sampler = params['sampling']
        self.bounds = bounds
        self.num_env = num_env
        self.gen = 0
        self.x_new = x0
    ...
    def new_pop(self):
        ...
        self.x_new = self.sampler(self.bounds[0], self.bounds[1], self.x.shape)
        self.x = x
        self.f = f
